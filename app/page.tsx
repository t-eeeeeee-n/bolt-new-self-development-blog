...
export default async function Home({ searchParams }: { searchParams: { page: string, q?: string } }) {
    ...
    const { posts, totalPages, totalPosts, currentPage } = await getPosts(page, searchQuery);
    ...
    return (
        <div className="container mx-auto px-4 py-8 grid grid-cols-12 gap-4">
            ...
            <div className="col-span-12 lg:col-span-6">
                <Client posts={posts} initialRecommendedPosts={recommendedPosts} totalPages={totalPages} totalPosts={totalPosts} />
            </div>
